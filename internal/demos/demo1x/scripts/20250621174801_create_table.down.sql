-- reverse -- CREATE TABLE `infos` (`id` bigint unsigned AUTO_INCREMENT,`created_at` datetime(3) NULL,`updated_at` datetime(3) NULL,`deleted_at` datetime(3) NULL,`name` varchar(191),`cate` longtext,PRIMARY KEY (`id`),INDEX `idx_infos_deleted_at` (`deleted_at`),CONSTRAINT `uni_infos_name` UNIQUE (`name`));
